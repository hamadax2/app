...
requirements = python3==3.9.10,hostpython3==3.9.10,kivy==2.2.0,https://github.com/kivymd/KivyMD/archive/master.zip,sdl2_ttf==2.0.15,kivymd==1.1.1,requests,chardet,idna,urllib3,certifi,soupsieve
